...
var Overlay = React.createClass({
    render: function () {
        var classList = ['overlay'];
        if (this.props.on) classList.push('overlay-on');
        return <div className={classList.join(' ')} onClick={this.props.close}></div>;
    }
});
var RevealBar = React.createClass({
    render: function () {
        var classList = ['reveal-bar'];
        if (this.props.on) classList.push('reveal-bar-on');
...
var NavDemo = React.createClass({
    ...
    render: function () {
        return (<nav>
            ...
            <Overlay on={this.state.on} close={this.onMenuToggle} />
            <RevealBar on={this.state.on} />
        </nav>
